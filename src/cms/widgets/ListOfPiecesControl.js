...
import { ObjectWidgetTopBar, colors, lengths } from 'netlify-cms-ui-default';
...
const NestedObjectLabel = _styled.div`
...
export default class ListControl extends React.Component {
  ...
  renderItem = (item, index) => {
    ...
    return (
      <SortableListItem
        css={[styles.listControlItem.styles, collapsed && styles.listControlItemCollapsed.styles]}
        index={index}
        key={`item-${index}`}
      >
  ...
  renderErroneousTypedItem(index, item) {
    ...
    return (
      <SortableListItem
        css={[styles.listControlItem.styles, styles.listControlItemCollapsed.styles]}
        index={index}
        key={`item-${index}`}
      >
        <StyledListItemTopBar
